...
<body>
	...
	<table border="1">
		<tr>
			<td>아이디</td>
			<td><input type="text" name="id" value="<%=idList[log]%>"></td>
		</tr>
		<tr>
			<td>패스워드</td>
			<td><input type="password" name="pw" value="0000"></td>
		</tr>
		<tr>
			<td>이름</td>
			<td><input type="text" name="name" value="<%=nameList[log] %>"></td>
		</tr>
		<tr>
			<td>성별</td>
			<td>
	...
	<button onclick="window.location.href='02_main.jsp'">메인화면</button>
	</div>
</body>
</html>